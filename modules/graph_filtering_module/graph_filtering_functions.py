...
class GraphFilteringWidget(QWidget):
    ...
    def __init__(self, mask, graph, viewer_images, image_path, output_path, output_basename, graph_topologies=None, mask_physical_pixel_sizes=(None, None, None), mask_channel_names=None, metadata=None):
        ...
        collapsible.content.setLayout(layout2)
        ...
        help_label.setWordWrap(True)
        help_label.setMinimumWidth(10)
        layout3.addWidget(help_label, 0, 0, 1, 2)
        ...
        layout3.addWidget(QLabel("Min area (pixel)"), 1, 0)
        layout3.addWidget(self.all_cells_min_area, 1, 1)
        ...
        layout3.addWidget(QLabel("Max area (pixel)"), 2, 0)
        layout3.addWidget(self.all_cells_max_area, 2, 1)
        ...
        layout3.addWidget(QLabel("Min area (pixel)"), 1, 0)
        layout3.addWidget(self.one_cell_min_area, 1, 1)
        ...
        layout3.addWidget(QLabel("Max area (pixel)"), 2, 0)
        layout3.addWidget(self.one_cell_max_area, 2, 1)
