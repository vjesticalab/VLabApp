...
from PyQt5.QtWidgets import QCheckBox, QFileDialog, QPushButton, QVBoxLayout, QWidget, QAbstractItemView, QGridLayout, QGroupBox, QLabel, QLineEdit, QHBoxLayout, QApplication, QListWidget
...
class Registration(QWidget):
    def __init__(self):
        ...
        self.displayC = QLabel('Double click on the transformationMatrix to view and edit it')
        self.matrices_list.setSelectionMode(QAbstractItemView.ExtendedSelection)
        self.add_file_buttonC = QPushButton("Add file", self)
        ...
        self.buttonC = QPushButton('Edit', self)
        ...
        layout2.addWidget(self.skip_cropping_yn_A)
        layout2.addWidget(self.buttonA, alignment=Qt.AlignCenter)
        ...
        layout2.addWidget(self.buttonB, alignment=Qt.AlignCenter)
        groupbox.setLayout(layout2)
        layout.addWidget(groupbox)

        groupbox = QGroupBox("Edit transformation matrices")
        layout2 = QVBoxLayout()
        layout2.addWidget(self.displayC)
        ...
        layout2.addLayout(layout3)
        layout2.addWidget(self.buttonC)
        groupbox.setLayout(layout2)
        layout.addWidget(groupbox)
    ...
    def register(self):
        ...
        for image_path in image_paths:
            if os.path.isfile(image_path):
                ...
                # Perform projection
                try:
                    f.registration_main(image_path, skip_crop_decision)
