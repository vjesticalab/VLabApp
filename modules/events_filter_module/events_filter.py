...
class GraphEventFilter(QWidget):
    def __init__(self):
        ...
        self.input_chimage = gf.FileLineEdit(label='Images', filetypes=gf.imagetypes)
        ...
        self.input_chcropimage = gf.FileLineEdit(label='Images', filetypes=gf.imagetypes)
        self.input_chcropimage.setEnabled(self.cropsave.isChecked())
        self.cropsave.toggled.connect(self.input_chcropimage.setEnabled)
        self.input_BFimage = gf.FileLineEdit(label='Images', filetypes=gf.imagetypes)
        ...
        layout2.addWidget(QLabel("Fusion marker image :"))
    ...
    def update_output_filename_label(self):
        ...
        self.output_filename_label3.setText(os.path.normpath(os.path.join(output_path,"<input basename>" + self.output_suffix + self.output_user_suffix.text() + ".graphmlz")))
